      * Qualified data names 
       ...
       PROGRAM-ID. SLSRPT06.
      *-----------------------------------------------------
      * Print test sales data Uses qualified data names.
      *-----------------------------------------------------
      ...
      *-----------------------------
       ...
       01  THE-DEPARTMENTS.
           05 FILLER       PIC 99 VALUE 01. 
           05 FILLER       PIC X(15) VALUE "EXCERCISE".
           05 FILLER       PIC 99 VALUE 02. 
       ...
       01  THE-CATEGORIES. 
           ...
           05 FILLER               PIC 99 VALUE 05. 
           05 FILLER               PIC X(15) VALUE "MEN'S CLOTHING".
           05 FILLER               PIC 99 VALUE 06. 
           05 FILLER               PIC X(15) VALUE "WOMEN'S CLOTHING".
      ...
      *PERFORM GET-OK-TO-PROCESS. 
       ...
       SORT-DATA-FILE.       
           SORT SORT-FILE       
               ON ASCENDING KEY SALES-STORE OF SORT-RECORD       
               ASCENDING KEY SALES-DIVISION OF SORT-RECORD       
               ASCENDING KEY SALES-DEPARTMENT OF SORT-RECORD       
               ASCENDING KEY SALES-CATEGORY OF SORT-RECORD       
               USING SALES-FILE       
               GIVING WORK-FILE.    
      ...
      * LEVEL 2 CONTROL BREAK
       PROCESS-ALL-STORES.
           ...
           PERFORM PROCESS-ALL-DIVISIONS    
               UNTIL WORK-FILE-AT-END = "Y"
                   OR SALES-STORE OF WORK-RECORD 
                       NOT = CURRENT-STORE.

           PERFORM END-ONE-STORE. 

       START-ONE-STORE.
           MOVE SALES-STORE OF WORK-RECORD TO CURRENT-STORE. 
           MOVE ZEROES TO STORE-TOTAL.
           MOVE SALES-STORE OF WORK-RECORD TO PRINT-STORE. 
       ...
       PROCESS-ALL-DIVISIONS. 
           ...
           PERFORM PROCESS-ALL-DEPARTMENTS 
               UNTIL WORK-FILE-AT-END = "Y"
                   OR SALES-STORE OF WORK-RECORD 
                    NOT = CURRENT-STORE 
                   OR SALES-DIVISION OF WORK-RECORD 
                       NOT = CURRENT-DIVISION. 

           PERFORM END-ONE-DIVISION. 

       START-ONE-DIVISION. 
           MOVE SALES-DIVISION OF WORK-RECORD TO CURRENT-DIVISION.
           MOVE ZEROES TO DIVISION-TOTAL. 
           MOVE SALES-DIVISION OF WORK-RECORD  TO PRINT-DIVISION.
       ...
       PROCESS-ALL-DEPARTMENTS.
           ...
           PERFORM PROCESS-ALL-CATEGORIES
               UNTIL WORK-FILE-AT-END = "Y"
                   ...
                   OR SALES-DIVISION OF WORK-RECORD 
                       NOT = CURRENT-DIVISION 
                   OR SALES-DEPARTMENT OF WORK-RECORD 
                       NOT = CURRENT-DEPARTMENT.               

           PERFORM END-ONE-DEPARTMENT.

       START-ONE-DEPARTMENT.
           MOVE SALES-DEPARTMENT OF WORK-RECORD
      ...
      * PROCESS ONE RECORD LEVEL 
       PROCESS-ALL-CATEGORIES.
           ...
           ADD SALES-AMOUNT OF WORK-RECORD 
               TO DEPARTMENT-TOTAL.
       ...
       PRINT-THE-RECORD.
           MOVE SALES-CATEGORY OF WORK-RECORD 
               TO PRINT-CATEGORY.

           PERFORM LOAD-CATEGORY-NAME. 

           MOVE SALES-AMOUNT OF WORK-RECORD 
               TO PRINT-AMOUNT.
