      * Printing in vendor name order. 

      * Output of this file (vnbynm01.cbl) prints the same 
      * information as vndrpt03.cbl but the records are 
      * in alphabetical order by name.
       IDENTIFICATION DIVISION.
       PROGRAM-ID. VNBYNM01.
      *------------------------------------------------------
      * Report on the Vendor File in alphabetical name order. 
      *-------------------------------------------------------
